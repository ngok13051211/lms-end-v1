            ...
            <div className="lg:col-span-2 flex flex-col">
                {conversationId && conversationLoading ? (
                    <Card className="h-full flex flex-col">
                        ...
                        </CardHeader>                        <CardContent className="h-[450px] overflow-y-auto p-4 space-y-4">
                    ...
                    <Card className="h-full flex flex-col">
                        ...
                        </CardHeader>                        <CardContent className="h-[370px] overflow-y-auto p-4 space-y-4">
                            <MessageList
