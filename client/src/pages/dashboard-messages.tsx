...
export default function DashboardMessages() {
  ...
  const {
    ...
    refetchInterval: 10000, // Auto-refresh every 10 seconds to get new messages
  });
              ...
              {conversationsLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  >
                    ...
                    {user?.role === "student" ? "Tìm gia sư" : "Tìm học viên"}
                  </Button>
                </div>
              )}
            </CardContent>
        ...
        <div className="lg:col-span-2 flex flex-col">
          {conversationId && conversationLoading ? (
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="h-[450px] overflow-y-auto p-4 space-y-4">
            ...
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="h-[370px] overflow-y-auto p-4 space-y-4">
                <MessageList
            ...
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="h-[500px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Chọn một cuộc trò chuyện từ danh sách bên trái để xem tin
                    nhắn hoặc bắt đầu một cuộc trò chuyện mới
                  </p>
                  <Button
                    className="mt-4"
                    onClick={() => setSearchDialogOpen(true)}
              ...
              <CardFooter className="p-4 border-t">
                <div className="flex w-full">
                  <div className="h-10 flex-1 bg-muted/20 rounded"></div>
                </div>
              </CardFooter>
            </Card>
          )}
  ...
  // Render với layout tương ứng và truyền prop activePage
