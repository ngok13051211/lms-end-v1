...
export default function StudentDashboardTutors() {
  ...
  const filteredTutors = Array.isArray(favoriteTutors)
    ? favoriteTutors.filter((tutor: FavoriteTutor) => {
            ...
            {filteredTutors.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-2 text-muted-foreground max-w-md mx-auto">
                  Không tìm thấy gia sư nào phù hợp với từ khóa "{searchQuery}".
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-2 text-muted-foreground max-w-md mx-auto">
                  Bạn chưa thêm gia sư nào vào danh sách yêu thích. Tìm kiếm gia
                  sư và nhấp vào biểu tượng ngôi sao để thêm họ vào danh sách
                  yêu thích.
                </p>
                <Button
                  className="mt-6"
