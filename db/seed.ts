...
async function seed() {
  try {
    ...
    const subjectsData = [
      {
        name: "Toán học",
        icon: "calculate",
        description: "Giảng dạy các chủ đề toán học từ cơ bản đến nâng cao",
      },
      {
        name: "Vật lý",
        icon: "science",
        description:
          "Khám phá các nguyên lý vật lý học qua lý thuyết và thực hành",
      },
      {
        name: "Hóa học",
        icon: "biotech",
        description: "Hiểu sâu về cấu trúc, tính chất và phản ứng của các chất",
      },
      {
        name: "Tiếng Anh",
        icon: "language",
        description:
          "Phát triển kỹ năng ngôn ngữ Anh từ giao tiếp đến học thuật",
      },
      {
        name: "Ngữ văn",
        icon: "menu_book",
        description: "Khám phá văn học Việt Nam và thế giới",
      },
      {
        name: "Địa lý",
        icon: "public",
        description:
          "Tìm hiểu về các đặc điểm tự nhiên và xã hội trên Trái Đất",
      },
      {
        name: "Lịch sử",
        icon: "history_edu",
        description: "Nghiên cứu các sự kiện lịch sử trong nước và quốc tế",
      },
      {
        name: "Tin học",
        icon: "computer",
        description: "Phát triển kỹ năng sử dụng máy tính và lập trình",
      },
    ];
    ...
    //     rating: 5,
    //     comment:
    //       "Con tôi tiến bộ rõ rệt sau 2 tháng học với gia sư Toán từ HomiTutor. Điểm số tăng từ 6 lên 8.5, và quan trọng hơn, cháu đã thực sự yêu thích môn Toán. Cảm ơn HomiTutor!",
    //     avatar:
    ...
    //     rating: 4,
    //     comment:
    //       "Cô Hà dạy tiếng Anh rất tận tâm và có phương pháp dễ hiểu. Tôi đã cải thiện khả năng giao tiếp tiếng Anh và đạt 7.5 IELTS sau 6 tháng học. Rất hài lòng với HomiTutor!",
    //     avatar:
    ...
    //     rating: 5,
    //     comment:
    //       "Việc tìm gia sư trên HomiTutor rất dễ dàng và an toàn. Tôi đánh giá cao quy trình xét duyệt gia sư kỹ lưỡng. Con trai tôi thích học với thầy Hoàng và đã tiến bộ nhiều trong môn Toán.",
    //     avatar:
    //       "https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80",
    //   },
    // ];
